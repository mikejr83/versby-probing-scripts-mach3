...
' Center X-X+Y+Y- Inside Probing Script
' Author verser
...
'main working
	...
	If Not SafeMoveY(-1*(GetOEMDRO(801)-Ypos),FRate1) Then 
		PushMSG("Return to the search position is interrupted")
		Exit Sub 
	End If
	'Probe Y-
	...
	Diameter=(Abs(XbHit-XHit+ProbeD)+Abs(YbHit-YHit-ProbeD))/2
